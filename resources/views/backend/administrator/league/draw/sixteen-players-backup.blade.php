...
@section('title', 'League Draw & Tree')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">League Draw & Tree ({{ count($players) }} Players)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard </a></li>
                                <li class="breadcrumb-item active" style="color: #74788d;">League Draw & Tree</li>
                            </ol>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body" style="text-align: center;">
                                ...
                                @csrf
                                    ...
                                    <input type="hidden" name="chk_type" value="League">
                                    ...
                                    <div class="row mb-4">
                                        <div>
                                            <h5 class="text-center text-info" style="font-weight:510;">Quarter Final</h5>
                                            <div class="input-daterange input-group" id="project-date-inputgroup" data-provide="datepicker" data-date-format="dd M, yyyy"  data-date-container='#project-date-inputgroup' data-date-autoclose="true">

                                                <input type="text" class="start form-control" @if($tournament->quarter_final_deadline) value="{{ $t_d_quar->start }}" @endif placeholder="Start Date" name="quar_start" required />
                                                <input type="text" class="end form-control" @if($tournament->quarter_final_deadline) value="{{ $t_d_quar->end }}" @endif placeholder="End Date" name="quar_end" required />
                                    ...
                                    <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3 mb-1" onclick="return confirm('Are you sure to set the schedule of the league?');"><i class="bx bx-add-to-queue label-icon"></i> Submit Deadlines <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                    ...
                                    <span style="margin-top:20px;"></span>
                                            ...
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.one', $tournament->id) }}" method="post" novalidate="">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_1_player_1" name="rou_1_mat_1_player_1" required>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_1_player_2" name="rou_1_mat_1_player_2" required>
                                            ...
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.two', $tournament->id) }}" method="post" novalidate="">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_2_player_1" name="rou_1_mat_2_player_1" required>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_2_player_2" name="rou_1_mat_2_player_2" required>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.three', $tournament->id) }}" method="post" novalidate="">
                                                    ...
                                                    <label class="form-label text-dark"> Match - 3 (Left)</label>
                                                    <div class="row">

                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_3_player_1" name="rou_1_mat_3_player_1" required>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_3_player_2" name="rou_1_mat_3_player_2" required>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.four', $tournament->id) }}" method="post" novalidate="">
                                                    ...
                                                    <label class="form-label text-dark"> Match - 4 (Left)</label>
                                                    <div class="row">

                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_4_player_1" name="rou_1_mat_4_player_1" required>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_4_player_2" name="rou_1_mat_4_player_2" required>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.five', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf

                                                    <label class="form-label text-dark"> Match - 5 (Right)</label>
                                                    <div class="row">

                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_5_player_1" name="rou_1_mat_5_player_1" required>
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    if($tournament->round_one_matches) {
                                                                        ...
                                                                        if(array_key_exists('match_5', $find_matches)) {
                                                                            $matches = $find_matches['match_5'];
                                                                            $match = explode(" VS ", $matches);
                                                                            array_push($rou_1_mat_5, \App\Models\User::findOrFail($match[0])->name);
                                                                            array_push($rou_1_mat_5, \App\Models\User::findOrFail($match[1])->name);
                                                                        }
                                                                    }
                                                                ?>
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_5', $round_one_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_5_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_5_player_2" name="rou_1_mat_5_player_2" required>
                                                                ...
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_5', $round_one_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_5_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($round_one_results) @if(array_key_exists('match_5', $round_one_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($round_one_matches) @if(array_key_exists('match_5', $round_one_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($round_one_matches) @if(array_key_exists('match_5', $round_one_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.six', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf

                                                    <label class="form-label text-dark"> Match - 6 (Right)</label>
                                                    <div class="row">

                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_6_player_1" name="rou_1_mat_6_player_1" required>
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    if($tournament->round_one_matches) {
                                                                        ...
                                                                        if(array_key_exists('match_6', $find_matches)) {
                                                                            $matches = $find_matches['match_6'];
                                                                            $match = explode(" VS ", $matches);
                                                                            array_push($rou_1_mat_6, \App\Models\User::findOrFail($match[0])->name);
                                                                            array_push($rou_1_mat_6, \App\Models\User::findOrFail($match[1])->name);
                                                                        }
                                                                    }
                                                                ?>
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_6', $round_one_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_6_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_6_player_2" name="rou_1_mat_6_player_2" required>
                                                                ...
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_6', $round_one_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_6_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($round_one_results) @if(array_key_exists('match_6', $round_one_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($round_one_matches) @if(array_key_exists('match_6', $round_one_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($round_one_matches) @if(array_key_exists('match_6', $round_one_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.seven', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf

                                                    <label class="form-label text-dark"> Match - 7 (Right)</label>
                                                    <div class="row">

                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_7_player_1" name="rou_1_mat_7_player_1" required>
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    if($tournament->round_one_matches) {
                                                                        ...
                                                                        if(array_key_exists('match_7', $find_matches)) {
                                                                            $matches = $find_matches['match_7'];
                                                                            $match = explode(" VS ", $matches);
                                                                            array_push($rou_1_mat_7, \App\Models\User::findOrFail($match[0])->name);
                                                                            array_push($rou_1_mat_7, \App\Models\User::findOrFail($match[1])->name);
                                                                        }
                                                                    }
                                                                ?>
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_7', $round_one_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_7_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_7_player_2" name="rou_1_mat_7_player_2" required>
                                                                ...
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_7', $round_one_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_7_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($round_one_results) @if(array_key_exists('match_7', $round_one_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($round_one_matches) @if(array_key_exists('match_7', $round_one_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($round_one_matches) @if(array_key_exists('match_7', $round_one_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                        </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.match.eight', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf

                                                    <label class="form-label text-dark"> Match - 8 (Right)</label>
                                                    <div class="row">

                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_8_player_1" name="rou_1_mat_8_player_1" required>
                                                                ...
                                                                <?php 
                                                                    ...
                                                                    if($tournament->round_one_matches) {
                                                                        ...
                                                                        if(array_key_exists('match_8', $find_matches)) {
                                                                            $matches = $find_matches['match_8'];
                                                                            $match = explode(" VS ", $matches);
                                                                            array_push($rou_1_mat_8, \App\Models\User::findOrFail($match[0])->name);
                                                                            array_push($rou_1_mat_8, \App\Models\User::findOrFail($match[1])->name);
                                                                        }
                                                                    }
                                                                ?>
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_8', $round_one_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_8_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <select class="form-control select2" id="rou_1_mat_8_player_2" name="rou_1_mat_8_player_2" required>
                                                                ...
                                                                @foreach($players as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($round_one_matches) @if(array_key_exists('match_8', $round_one_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_8_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-5">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($round_one_results) @if(array_key_exists('match_8', $round_one_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($round_one_matches) @if(array_key_exists('match_8', $round_one_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($round_one_matches) @if(array_key_exists('match_8', $round_one_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                        </div>
                                            ...
                                            <form class="needs-validation" action="{{ route('submit.round.one.auto.selection', $tournament->id) }}" method="post" novalidate="">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <select class="form-control select2" id="rou1_mat_auto_player" name="rou1_mat_auto_player" required>
                                                            ...
                                                            @foreach($players as $player)
                                                                ...
                                                                <option value="{{ $user->id }}" @if($round_one_auto_selection) {{ $auto_player == $user->id ? "selected" : "" }} @else {{ old('rou1_mat_auto_player') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <select class="form-control select2" id="rou1_mat_auto" name="rou1_mat_auto" required>
                                                            ...
                                                            @for($i = 1; $i < 9; $i++)
                                                                ...
                                                                ?>
                                                                <option value="match_{{ $i }}" @if($round_one_auto_selection) @if(array_key_exists('match_'.$i, $round_one_auto_selection)) selected @endif @endif>Match - {{ $i }}</option>
                                                            @endfor
                                                    ...
                                                    <div class="col-5">
                                                        <button type="submit" class="btn btn-info btn-label waves-effect waves-light mt-3" style="margin: 0 auto; width: 100%;" @if($tournament->round_one_auto_selection) onclick="return confirm('Match auto selection has been performed already. Are you sure to change the selection and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match auto selection and send SMS to the player?');" @endif><i class="bx bx-add-to-queue label-icon"></i> @if($tournament->round_one_auto_selection) Change @else Submit @endif Automatic Selection <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <span style="margin-top:20px;"></span>
                                            ...
                                            <div class="col-xl-6 mt-4">
                                                ...
                                                @csrf
                                                    <label class="form-label text-dark" style="border:1px dashed #ddd; padding: 7px; border-radius: 2px; margin-bottom: 15px;"> Match - 3 (Left)</label>
                                            ...
                                            <div class="col-xl-6 mt-4">
                                                ...
                                                @csrf
                                                    <label class="form-label text-dark" style="border:1px dashed #ddd; padding: 7px; border-radius: 2px; margin-bottom: 15px;"> Match - 4 (Left)</label>
                                            ...
                                            <div class="col-xl-6 mt-4">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.result.five', $tournament->id) }}" method="post" novalidate="">
                                                @csrf
                                                    <label class="form-label text-dark" style="border:1px dashed #ddd; padding: 7px; border-radius: 2px; margin-bottom: 15px;"> Match - 5 (Right)</label>
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($tournament->round_one_matches) {
                                                            ...
                                                            if(array_key_exists('match_5', $find_matches)) {
                                                                ...
                                                                $p1_m5 = \App\Models\User::findOrFail($match[0]);
                                                                $p2_m5 = \App\Models\User::findOrFail($match[1]);
                                                            }
                                                        ...
                                                        if($tournament->round_one_results) {
                                                            ...
                                                            if(array_key_exists('match_5', $find_results)) {
                                                                $results = $find_results['match_5'];
                                                                foreach($results as $result_array) {
                                                                    if(array_key_exists('set_1', $result_array)) {
                                                                        $rs = $result_array['set_1'];
                                                                        array_push($rou1_m5_s1, $rs);
                                                                    }

                                                                    if(array_key_exists('set_2', $result_array)) {
                                                                        $rs2 = $result_array['set_2'];
                                                                        array_push($rou1_m5_s2, $rs2);
                                                                    }

                                                                    if(array_key_exists('set_3', $result_array)) {
                                                                        $rs3 = $result_array['set_3'];
                                                                        array_push($rou1_m5_s3, $rs3);
                                                                    }
                                                                }
                                                            }
                                                    ...
                                                    <input type="hidden" name="p1_m5" value="@if(array_key_exists('match_5', $round_one_matches)) {{ $p1_m5->id }} @endif">
                                                    <input type="hidden" name="p2_m5" value="@if(array_key_exists('match_5', $round_one_matches)) {{ $p2_m5->id }} @endif">

                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_5', $round_one_matches)) {{ $p1_m5->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m5_s1 ? $rou1_m5_s1[0] : '' }}" @endif name="p1_m5_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m5_s2 ? $rou1_m5_s2[0] : '' }}" @endif name="p1_m5_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m5_s3 ? $rou1_m5_s3[0] : '' }}" @endif name="p1_m5_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_5', $round_one_matches)) {{ $p2_m5->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m5_s1 ? $rou1_m5_s1[1] : '' }}" @endif name="p2_m5_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m5_s2 ? $rou1_m5_s2[1] : '' }}" @endif name="p2_m5_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m5_s3 ? $rou1_m5_s3[1] : '' }}" @endif name="p2_m5_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2" style="margin-top: 20px;">
                                                        <label for="rou_1_mat_5_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="mb-1 position-relative">
                                                                <select class="form-control select2" id="rou_1_mat_5_status" name="rou_1_mat_5_status">
                                            
                                                                    <option value="">Select Status</option>

                                                                    <option value="Withdraw" @if($round_one_status) @if(array_key_exists('match_5', $round_one_status)) {{ $round_one_status['match_5'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                    <option value="Retired" @if($round_one_status) @if(array_key_exists('match_5', $round_one_status)) {{ $round_one_status['match_5'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                    <option value="Decided by Organisers" @if($round_one_status) @if(array_key_exists('match_5', $round_one_status)) {{ $round_one_status['match_5'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8 mb-4">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                @if($round_one_results) 
                                                                    @if(array_key_exists('match_5', $round_one_results)) 
                                                                        onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                    @else
                                                                        onclick="return confirm('Are you sure to submit the match result?');"
                                                                    @endif 
                                            ...
                                            <div class="col-xl-6 mt-4">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.result.six', $tournament->id) }}" method="post" novalidate="">
                                                @csrf
                                                    <label class="form-label text-dark" style="border:1px dashed #ddd; padding: 7px; border-radius: 2px; margin-bottom: 15px;"> Match - 6 (Right)</label>
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($tournament->round_one_matches) {
                                                            ...
                                                            if(array_key_exists('match_6', $find_matches)) {
                                                                ...
                                                                $p1_m6 = \App\Models\User::findOrFail($match[0]);
                                                                $p2_m6 = \App\Models\User::findOrFail($match[1]);
                                                            }
                                                        ...
                                                        if($tournament->round_one_results) {
                                                            ...
                                                            if(array_key_exists('match_6', $find_results)) {
                                                                $results = $find_results['match_6'];
                                                                foreach($results as $result_array) {
                                                                    if(array_key_exists('set_1', $result_array)) {
                                                                        $rs = $result_array['set_1'];
                                                                        array_push($rou1_m6_s1, $rs);
                                                                    }

                                                                    if(array_key_exists('set_2', $result_array)) {
                                                                        $rs2 = $result_array['set_2'];
                                                                        array_push($rou1_m6_s2, $rs2);
                                                                    }

                                                                    if(array_key_exists('set_3', $result_array)) {
                                                                        $rs3 = $result_array['set_3'];
                                                                        array_push($rou1_m6_s3, $rs3);
                                                                    }
                                                                }
                                                            }
                                                    ...
                                                    <input type="hidden" name="p1_m6" value="@if(array_key_exists('match_6', $round_one_matches)) {{ $p1_m6->id }} @endif">
                                                    <input type="hidden" name="p2_m6" value="@if(array_key_exists('match_6', $round_one_matches)) {{ $p2_m6->id }} @endif">

                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_6', $round_one_matches)) {{ $p1_m6->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m6_s1 ? $rou1_m6_s1[0] : '' }}" @endif name="p1_m6_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m6_s2 ? $rou1_m6_s2[0] : '' }}" @endif name="p1_m6_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m6_s3 ? $rou1_m6_s3[0] : '' }}" @endif name="p1_m6_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_6', $round_one_matches)) {{ $p2_m6->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m6_s1 ? $rou1_m6_s1[1] : '' }}" @endif name="p2_m6_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m6_s2 ? $rou1_m6_s2[1] : '' }}" @endif name="p2_m6_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m6_s3 ? $rou1_m6_s3[1] : '' }}" @endif name="p2_m6_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2" style="margin-top: 20px;">
                                                        <label for="rou_1_mat_6_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="mb-1 position-relative">
                                                                <select class="form-control select2" id="rou_1_mat_6_status" name="rou_1_mat_6_status">
                                            
                                                                    <option value="">Select Status</option>

                                                                    <option value="Withdraw" @if($round_one_status) @if(array_key_exists('match_6', $round_one_status)) {{ $round_one_status['match_6'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                    <option value="Retired" @if($round_one_status) @if(array_key_exists('match_6', $round_one_status)) {{ $round_one_status['match_6'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                    <option value="Decided by Organisers" @if($round_one_status) @if(array_key_exists('match_6', $round_one_status)) {{ $round_one_status['match_6'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8 mb-4">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                @if($round_one_results) 
                                                                    @if(array_key_exists('match_6', $round_one_results)) 
                                                                        onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                    @else
                                                                        onclick="return confirm('Are you sure to submit the match result?');"
                                                                    @endif 
                                            ...
                                            <div class="col-xl-6 mt-4">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.result.seven', $tournament->id) }}" method="post" novalidate="">
                                                @csrf
                                                    <label class="form-label text-dark" style="border:1px dashed #ddd; padding: 7px; border-radius: 2px; margin-bottom: 15px;"> Match - 7 (Right)</label>
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($tournament->round_one_matches) {
                                                            ...
                                                            if(array_key_exists('match_7', $find_matches)) {
                                                                ...
                                                                $p1_m7 = \App\Models\User::findOrFail($match[0]);
                                                                $p2_m7 = \App\Models\User::findOrFail($match[1]);
                                                            }
                                                        ...
                                                        if($tournament->round_one_results) {
                                                            ...
                                                            if(array_key_exists('match_7', $find_results)) {
                                                                $results = $find_results['match_7'];
                                                                foreach($results as $result_array) {
                                                                    if(array_key_exists('set_1', $result_array)) {
                                                                        $rs = $result_array['set_1'];
                                                                        array_push($rou1_m7_s1, $rs);
                                                                    }

                                                                    if(array_key_exists('set_2', $result_array)) {
                                                                        $rs2 = $result_array['set_2'];
                                                                        array_push($rou1_m7_s2, $rs2);
                                                                    }

                                                                    if(array_key_exists('set_3', $result_array)) {
                                                                        $rs3 = $result_array['set_3'];
                                                                        array_push($rou1_m7_s3, $rs3);
                                                                    }
                                                                }
                                                            }
                                                    ...
                                                    <input type="hidden" name="p1_m7" value="@if(array_key_exists('match_7', $round_one_matches)) {{ $p1_m7->id }} @endif">
                                                    <input type="hidden" name="p2_m7" value="@if(array_key_exists('match_7', $round_one_matches)) {{ $p2_m7->id }} @endif">

                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_7', $round_one_matches)) {{ $p1_m7->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m7_s1 ? $rou1_m7_s1[0] : '' }}" @endif name="p1_m7_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m7_s2 ? $rou1_m7_s2[0] : '' }}" @endif name="p1_m7_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m7_s3 ? $rou1_m7_s3[0] : '' }}" @endif name="p1_m7_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_7', $round_one_matches)) {{ $p2_m7->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m7_s1 ? $rou1_m7_s1[1] : '' }}" @endif name="p2_m7_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m7_s2 ? $rou1_m7_s2[1] : '' }}" @endif name="p2_m7_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m7_s3 ? $rou1_m7_s3[1] : '' }}" @endif name="p2_m7_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2" style="margin-top: 20px;">
                                                        <label for="rou_1_mat_7_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="mb-1 position-relative">
                                                                <select class="form-control select2" id="rou_1_mat_7_status" name="rou_1_mat_7_status">
                                            
                                                                    <option value="">Select Status</option>

                                                                    <option value="Withdraw" @if($round_one_status) @if(array_key_exists('match_7', $round_one_status)) {{ $round_one_status['match_7'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                    <option value="Retired" @if($round_one_status) @if(array_key_exists('match_7', $round_one_status)) {{ $round_one_status['match_7'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                    <option value="Decided by Organisers" @if($round_one_status) @if(array_key_exists('match_7', $round_one_status)) {{ $round_one_status['match_7'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8 mb-4">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                @if($round_one_results) 
                                                                    @if(array_key_exists('match_7', $round_one_results)) 
                                                                        onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                    @else
                                                                        onclick="return confirm('Are you sure to submit the match result?');"
                                                                    @endif 
                                            ...
                                            <div class="col-xl-6 mt-4">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.round.one.result.eight', $tournament->id) }}" method="post" novalidate="">
                                                @csrf
                                                    <label class="form-label text-dark" style="border:1px dashed #ddd; padding: 7px; border-radius: 2px; margin-bottom: 15px;"> Match - 8 (Right)</label>
                                                    ...
                                                    <?php 
                                                        ...
                                                        if($tournament->round_one_matches) {
                                                            ...
                                                            if(array_key_exists('match_8', $find_matches)) {
                                                                ...
                                                                $p1_m8 = \App\Models\User::findOrFail($match[0]);
                                                                $p2_m8 = \App\Models\User::findOrFail($match[1]);
                                                            }
                                                        ...
                                                        if($tournament->round_one_results) {
                                                            ...
                                                            if(array_key_exists('match_8', $find_results)) {
                                                                $results = $find_results['match_8'];
                                                                foreach($results as $result_array) {
                                                                    if(array_key_exists('set_1', $result_array)) {
                                                                        $rs = $result_array['set_1'];
                                                                        array_push($rou1_m8_s1, $rs);
                                                                    }

                                                                    if(array_key_exists('set_2', $result_array)) {
                                                                        $rs2 = $result_array['set_2'];
                                                                        array_push($rou1_m8_s2, $rs2);
                                                                    }

                                                                    if(array_key_exists('set_3', $result_array)) {
                                                                        $rs3 = $result_array['set_3'];
                                                                        array_push($rou1_m8_s3, $rs3);
                                                                    }
                                                                }
                                                            }
                                                    ...
                                                    <input type="hidden" name="p1_m8" value="@if(array_key_exists('match_8', $round_one_matches)) {{ $p1_m8->id }} @endif">
                                                    <input type="hidden" name="p2_m8" value="@if(array_key_exists('match_8', $round_one_matches)) {{ $p2_m8->id }} @endif">

                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_8', $round_one_matches)) {{ $p1_m8->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m8_s1 ? $rou1_m8_s1[0] : '' }}" @endif name="p1_m8_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m8_s2 ? $rou1_m8_s2[0] : '' }}" @endif name="p1_m8_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m8_s3 ? $rou1_m8_s3[0] : '' }}" @endif name="p1_m8_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2">
                                                        <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_8', $round_one_matches)) {{ $p2_m8->name }} @else N/A @endif</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->round_one_results) value="{{ $rou1_m8_s1 ? $rou1_m8_s1[1] : '' }}" @endif name="p2_m8_s1" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->round_one_results) value="{{ $rou1_m8_s2 ? $rou1_m8_s2[1] : '' }}" @endif name="p2_m8_s2" required="">
                                                                </div>

                                                                <div class="col-4">
                                                                    <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->round_one_results) value="{{ $rou1_m8_s3 ? $rou1_m8_s3[1] : '' }}" @endif name="p2_m8_s3">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mb-2" style="margin-top: 20px;">
                                                        <label for="rou_1_mat_8_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                        
                                                        <div class="col-xl-8">
                                                            <div class="mb-1 position-relative">
                                                                <select class="form-control select2" id="rou_1_mat_8_status" name="rou_1_mat_8_status">
                                            
                                                                    <option value="">Select Status</option>

                                                                    <option value="Withdraw" @if($round_one_status) @if(array_key_exists('match_8', $round_one_status)) {{ $round_one_status['match_8'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                    <option value="Retired" @if($round_one_status) @if(array_key_exists('match_8', $round_one_status)) {{ $round_one_status['match_8'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                    <option value="Decided by Organisers" @if($round_one_status) @if(array_key_exists('match_8', $round_one_status)) {{ $round_one_status['match_8'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8 mb-4">
                                                            <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                @if($round_one_results) 
                                                                    @if(array_key_exists('match_8', $round_one_results)) 
                                                                        onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                    @else
                                                                        onclick="return confirm('Are you sure to submit the match result?');"
                                                                    @endif 
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        <label class="form-label text-dark"> Match - 5 (Right)</label>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <select class="form-control select2" id="rou_1_mat_5_winner" name="rou_1_mat_5_winner" required>
                                                                        ...
                                                                        <option value="">Select Player</option>
                                                                            ...
                                                                            @foreach($match as $value)
                                                                                <?php 
                                                                                    $user = \App\Models\User::findOrFail($value);
                                                                                ?>
                                                                                <option value="{{ $user->id }}" @if($tournament->round_one_winners) @if(array_key_exists('match_5', $round_one_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('rou_1_mat_5_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_5_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                            @endforeach
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        <label class="form-label text-dark"> Match - 6 (Right)</label>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <select class="form-control select2" id="rou_1_mat_6_winner" name="rou_1_mat_6_winner" required>
                                                                        ...
                                                                        <option value="">Select Player</option>
                                                                            ...
                                                                            @foreach($match as $value)
                                                                                <?php 
                                                                                    $user = \App\Models\User::findOrFail($value);
                                                                                ?>
                                                                                <option value="{{ $user->id }}" @if($tournament->round_one_winners) @if(array_key_exists('match_6', $round_one_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('rou_1_mat_6_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_6_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                            @endforeach
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        <label class="form-label text-dark"> Match - 7 (Right)</label>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <select class="form-control select2" id="rou_1_mat_7_winner" name="rou_1_mat_7_winner" required>
                                                                        ...
                                                                        <option value="">Select Player</option>
                                                                            ...
                                                                            @foreach($match as $value)
                                                                                <?php 
                                                                                    $user = \App\Models\User::findOrFail($value);
                                                                                ?>
                                                                                <option value="{{ $user->id }}" @if($tournament->round_one_winners) @if(array_key_exists('match_7', $round_one_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('rou_1_mat_7_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_7_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                            @endforeach
                                                    ...
                                                    <div class="mb-3 position-relative">
                                                        <label class="form-label text-dark"> Match - 8 (Right)</label>
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <select class="form-control select2" id="rou_1_mat_8_winner" name="rou_1_mat_8_winner" required>
                                                                        ...
                                                                        <option value="">Select Player</option>
                                                                            ...
                                                                            @foreach($match as $value)
                                                                                <?php 
                                                                                    $user = \App\Models\User::findOrFail($value);
                                                                                ?>
                                                                                <option value="{{ $user->id }}" @if($tournament->round_one_winners) @if(array_key_exists('match_8', $round_one_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('rou_1_mat_8_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('rou_1_mat_8_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                            @endforeach
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <span style="margin-top:20px;"></span>
                                            ...
                                            <?php 
                                                ...
                                                if(array_key_exists('match_5', $w_arr)) {
                                                    $win = $w_arr['match_5'];
                                                    array_push($winners, $win);
                                                }

                                                if(array_key_exists('match_6', $w_arr)) {
                                                    $win = $w_arr['match_6'];
                                                    array_push($winners, $win);
                                                }

                                                if(array_key_exists('match_7', $w_arr)) {
                                                    $win = $w_arr['match_7'];
                                                    array_push($winners, $win);
                                                }

                                                if(array_key_exists('match_8', $w_arr)) {
                                                    $win = $w_arr['match_8'];
                                                    array_push($winners, $win);
                                                }
                                            ?>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.match.one', $tournament->id) }}" method="post" novalidate="">
                                                        @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_1_player_1" name="quar_mat_1_player_1" required>
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        if($tournament->quarter_final_matches) {
                                                                            ...
                                                                            if(array_key_exists('match_1', $find_matches)) {
                                                                                $matches = $find_matches['match_1'];
                                                                                $match = explode(" VS ", $matches);
                                                                                array_push($quar_mat_1, \App\Models\User::findOrFail($match[0])->name);
                                                                                array_push($quar_mat_1, \App\Models\User::findOrFail($match[1])->name);
                                                                            }
                                                                        }
                                                                    ?>
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_1', $quarter_final_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_1_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_1_player_2" name="quar_mat_1_player_2" required>
                                                                    ...
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_1', $quarter_final_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_1_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($quarter_final_results) @if(array_key_exists('match_1', $quarter_final_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($quarter_final_matches) @if(array_key_exists('match_1', $quarter_final_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($quarter_final_matches) @if(array_key_exists('match_1', $quarter_final_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.match.two', $tournament->id) }}" method="post" novalidate="">
                                                        @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_2_player_1" name="quar_mat_2_player_1" required>
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        if($tournament->quarter_final_matches) {
                                                                            ...
                                                                            if(array_key_exists('match_2', $find_matches)) {
                                                                                $matches = $find_matches['match_2'];
                                                                                $match = explode(" VS ", $matches);
                                                                                array_push($quar_mat_2, \App\Models\User::findOrFail($match[0])->name);
                                                                                array_push($quar_mat_2, \App\Models\User::findOrFail($match[1])->name);
                                                                            }
                                                                        }
                                                                    ?>
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_2', $quarter_final_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_2_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_2_player_2" name="quar_mat_2_player_2" required>
                                                                    ...
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_2', $quarter_final_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_2_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($quarter_final_results) @if(array_key_exists('match_2', $quarter_final_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($quarter_final_matches) @if(array_key_exists('match_2', $quarter_final_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($quarter_final_matches) @if(array_key_exists('match_2', $quarter_final_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.match.three', $tournament->id) }}" method="post" novalidate="">
                                                        @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_3_player_1" name="quar_mat_3_player_1" required>
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        if($tournament->quarter_final_matches) {
                                                                            ...
                                                                            if(array_key_exists('match_3', $find_matches)) {
                                                                                $matches = $find_matches['match_3'];
                                                                                $match = explode(" VS ", $matches);
                                                                                array_push($quar_mat_3, \App\Models\User::findOrFail($match[0])->name);
                                                                                array_push($quar_mat_3, \App\Models\User::findOrFail($match[1])->name);
                                                                            }
                                                                        }
                                                                    ?>
                                                                    ...
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_3', $quarter_final_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_3_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_3_player_2" name="quar_mat_3_player_2" required>
                                                                    ...
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_3', $quarter_final_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_3_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($quarter_final_results) @if(array_key_exists('match_3', $quarter_final_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($quarter_final_matches) @if(array_key_exists('match_3', $quarter_final_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($quarter_final_matches) @if(array_key_exists('match_3', $quarter_final_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.match.four', $tournament->id) }}" method="post" novalidate="">
                                                        @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_4_player_1" name="quar_mat_4_player_1" required>
                                                                    ...
                                                                    <?php 
                                                                        ...
                                                                        if($tournament->quarter_final_matches) {
                                                                            ...
                                                                            if(array_key_exists('match_4', $find_matches)) {
                                                                                $matches = $find_matches['match_4'];
                                                                                $match = explode(" VS ", $matches);
                                                                                array_push($quar_mat_4, \App\Models\User::findOrFail($match[0])->name);
                                                                                array_push($quar_mat_4, \App\Models\User::findOrFail($match[1])->name);
                                                                            }
                                                                        }
                                                                    ?>
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_4', $quarter_final_matches)) {{ $match[0] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_4_player_1') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <select class="form-control select2" id="quar_mat_4_player_2" name="quar_mat_4_player_2" required>
                                                                    ...
                                                                    @foreach($winners as $player)
                                                                        ...
                                                                        <option value="{{ $user->id }}" @if($quarter_final_matches) @if(array_key_exists('match_4', $quarter_final_matches)) {{ $match[1] == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_4_player_2') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                            ...
                                                            <div class="col-5">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" @if($quarter_final_results) @if(array_key_exists('match_4', $quarter_final_results)) disabled @endif @endif style="margin: 0 auto; width: 100%;" @if($quarter_final_matches) @if(array_key_exists('match_4', $quarter_final_matches)) onclick="return confirm('Match draw has been performed already. Are you sure to change the draw and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif @else onclick="return confirm('Are you sure to make the match draw and send SMS to the players?');" @endif ><i class="bx bx-add-to-queue label-icon"></i> @if($quarter_final_matches) @if(array_key_exists('match_4', $quarter_final_matches)) Change @else Submit @endif @else Submit @endif Match <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                            </div>
                                        ...
                                        <div class="col-xl-12">
                                            <div class="mb-3 position-relative">
                                                ...
                                                <form class="needs-validation" action="{{ route('submit.quarter.final.auto.selection', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control select2" id="quar_mat_auto_player" name="quar_mat_auto_player" required>
                                                                ...
                                                                @foreach($winners as $player)
                                                                    ...
                                                                    <option value="{{ $user->id }}" @if($quarter_final_auto_selection) {{ $auto_player == $user->id ? "selected" : "" }} @else {{ old('quar_mat_auto_player') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                        ...
                                                        <div class="col-6">
                                                            ...
                                                            <select class="form-control select2" id="quar_mat_auto" name="quar_mat_auto" required>
                                                                ...
                                                                @for($i = 1; $i < 5; $i++)
                                                                    <?php 
                                                                        $match_word = strtolower(ucwords((new NumberFormatter('en_IN', NumberFormatter::SPELLOUT))->format($i)));
                                                                    ?>
                                                                    <option value="match_{{ $i }}" @if($quarter_final_auto_selection) @if(array_key_exists('match_'.$i, $quarter_final_auto_selection)) selected @endif @endif>Match - {{ $i }}</option>
                                                                @endfor
                                                        ...
                                                        <div class="col-5">
                                                            <button type="submit" class="btn btn-info btn-label waves-effect waves-light mt-3" style="margin: 0 auto; width: 100%;" @if($tournament->quarter_final_auto_selection) onclick="return confirm('Match auto selection has been performed already. Are you sure to change the selection and send SMS to the players again?');" @else onclick="return confirm('Are you sure to make the match auto selection and send SMS to the player?');" @endif><i class="bx bx-add-to-queue label-icon"></i> @if($tournament->quarter_final_auto_selection) Change @else Submit @endif Automatic Selection <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <span style="margin-top:20px;"></span>
                                                ...
                                                <div class="col-xl-6 mt-4">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.result.one', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf
                                                            ...
                                                            if($tournament->quarter_final_results) {
                                                                ...
                                                                if(array_key_exists('match_1', $find_results)) {
                                                                    ...
                                                                    foreach($results as $result_array) {
                                                                        if(array_key_exists('set_1', $result_array)) {
                                                                            $rs = $result_array['set_1'];
                                                                            array_push($quar_m1_s1, $rs);
                                                                        }

                                                                        if(array_key_exists('set_2', $result_array)) {
                                                                            $rs2 = $result_array['set_2'];
                                                                            array_push($quar_m1_s2, $rs2);
                                                                        }

                                                                        if(array_key_exists('set_3', $result_array)) {
                                                                            $rs3 = $result_array['set_3'];
                                                                            array_push($quar_m1_s3, $rs3);
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        <input type="hidden" name="p1_m1" value="@if(array_key_exists('match_1', $quarter_final_matches)) {{ $p1_m1->id }} @endif">
                                                        <input type="hidden" name="p2_m1" value="@if(array_key_exists('match_1', $quarter_final_matches)) {{ $p2_m1->id }} @endif">

                                                        <div class="row mb-2">
                                                            
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_1', $quarter_final_matches)) {{ $p1_m1->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m1_s1 ? $quar_m1_s1[0] : '' }}" @endif name="p1_m1_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m1_s2 ? $quar_m1_s2[0] : '' }}" @endif name="p1_m1_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m1_s3 ? $quar_m1_s3[0] : '' }}" @endif name="p1_m1_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_1', $quarter_final_matches)) {{ $p2_m1->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m1_s1 ? $quar_m1_s1[1] : '' }}" @endif name="p2_m1_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m1_s2 ? $quar_m1_s2[1] : '' }}" @endif name="p2_m1_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m1_s3 ? $quar_m1_s3[1] : '' }}" @endif name="p2_m1_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2" style="margin-top: 20px;">
                                                            <label for="quar_mat_1_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="mb-1 position-relative">
                                                                    <select class="form-control select2" id="quar_mat_1_status" name="quar_mat_1_status">
                                                
                                                                        <option value="">Select Status</option>

                                                                        <option value="Withdraw" @if($quarter_final_status) @if(array_key_exists('match_1', $quarter_final_status)) {{ $quarter_final_status['match_1'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                        <option value="Retired" @if($quarter_final_status) @if(array_key_exists('match_1', $quarter_final_status)) {{ $quarter_final_status['match_1'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                        <option value="Decided by Organisers" @if($quarter_final_status) @if(array_key_exists('match_1', $quarter_final_status)) {{ $quarter_final_status['match_1'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8 mb-4">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                    @if($quarter_final_results) 
                                                                        @if(array_key_exists('match_1', $quarter_final_results)) 
                                                                            onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                        @else
                                                                            onclick="return confirm('Are you sure to submit the match result?');"
                                                                        @endif 
                                                ...
                                                <div class="col-xl-6 mt-4">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.result.two', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf
                                                        <label class="form-label text-dark" style="border:1px dashed #ddd; padding: 7px; border-radius: 2px; margin-bottom: 15px;"> Match - 2 (Left)</label>
                                                            ...
                                                            if($tournament->quarter_final_results) {
                                                                ...
                                                                if(array_key_exists('match_2', $find_results)) {
                                                                    ...
                                                                    foreach($results as $result_array) {
                                                                        if(array_key_exists('set_1', $result_array)) {
                                                                            $rs = $result_array['set_1'];
                                                                            array_push($quar_m2_s1, $rs);
                                                                        }

                                                                        if(array_key_exists('set_2', $result_array)) {
                                                                            $rs2 = $result_array['set_2'];
                                                                            array_push($quar_m2_s2, $rs2);
                                                                        }

                                                                        if(array_key_exists('set_3', $result_array)) {
                                                                            $rs3 = $result_array['set_3'];
                                                                            array_push($quar_m2_s3, $rs3);
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        <input type="hidden" name="p1_m2" value="@if(array_key_exists('match_2', $quarter_final_matches)) {{ $p1_m2->id }} @endif">
                                                        <input type="hidden" name="p2_m2" value="@if(array_key_exists('match_2', $quarter_final_matches)) {{ $p2_m2->id }} @endif">

                                                        <div class="row mb-2">
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_2', $quarter_final_matches)) {{ $p1_m2->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m2_s1 ? $quar_m2_s1[0] : '' }}" @endif name="p1_m2_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m2_s2 ? $quar_m2_s2[0] : '' }}" @endif name="p1_m2_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m2_s3 ? $quar_m2_s3[0] : '' }}" @endif name="p1_m2_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_2', $quarter_final_matches)) {{ $p2_m2->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m2_s1 ? $quar_m2_s1[1] : '' }}" @endif name="p2_m2_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m2_s2 ? $quar_m2_s2[1] : '' }}" @endif name="p2_m2_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m2_s3 ? $quar_m2_s3[1] : '' }}" @endif name="p2_m2_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2" style="margin-top: 20px;">
                                                            <label for="quar_mat_2_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="mb-1 position-relative">
                                                                    <select class="form-control select2" id="quar_mat_2_status" name="quar_mat_2_status">
                                                
                                                                        <option value="">Select Status</option>

                                                                        <option value="Withdraw" @if($quarter_final_status) @if(array_key_exists('match_2', $quarter_final_status)) {{ $quarter_final_status['match_2'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                        <option value="Retired" @if($quarter_final_status) @if(array_key_exists('match_2', $quarter_final_status)) {{ $quarter_final_status['match_2'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                        <option value="Decided by Organisers" @if($quarter_final_status) @if(array_key_exists('match_2', $quarter_final_status)) {{ $quarter_final_status['match_2'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8 mb-4">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                    @if($quarter_final_results) 
                                                                        @if(array_key_exists('match_2', $quarter_final_results)) 
                                                                            onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                        @else
                                                                            onclick="return confirm('Are you sure to submit the match result?');"
                                                                        @endif 
                                                ...
                                                <div class="col-xl-6 mt-4">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.result.three', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf
                                                            ...
                                                            if($tournament->quarter_final_results) {
                                                                ...
                                                                if(array_key_exists('match_3', $find_results)) {
                                                                    ...
                                                                    foreach($results as $result_array) {
                                                                        if(array_key_exists('set_1', $result_array)) {
                                                                            $rs = $result_array['set_1'];
                                                                            array_push($quar_m3_s1, $rs);
                                                                        }

                                                                        if(array_key_exists('set_2', $result_array)) {
                                                                            $rs2 = $result_array['set_2'];
                                                                            array_push($quar_m3_s2, $rs2);
                                                                        }

                                                                        if(array_key_exists('set_3', $result_array)) {
                                                                            $rs3 = $result_array['set_3'];
                                                                            array_push($quar_m3_s3, $rs3);
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        <input type="hidden" name="p1_m3" value="@if(array_key_exists('match_3', $quarter_final_matches)) {{ $p1_m3->id }} @endif">
                                                        <input type="hidden" name="p2_m3" value="@if(array_key_exists('match_3', $quarter_final_matches)) {{ $p2_m3->id }} @endif">

                                                        <div class="row mb-2">
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_3', $quarter_final_matches)) {{ $p1_m3->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m3_s1 ? $quar_m3_s1[0] : '' }}" @endif name="p1_m3_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m3_s2 ? $quar_m3_s2[0] : '' }}" @endif name="p1_m3_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m3_s3 ? $quar_m3_s3[0] : '' }}" @endif name="p1_m3_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_3', $quarter_final_matches)) {{ $p2_m3->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m3_s1 ? $quar_m3_s1[1] : '' }}" @endif name="p2_m3_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m3_s2 ? $quar_m3_s2[1] : '' }}" @endif name="p2_m3_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m3_s3 ? $quar_m3_s3[1] : '' }}" @endif name="p2_m3_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2" style="margin-top: 20px;">
                                                            <label for="quar_mat_3_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="mb-1 position-relative">
                                                                    <select class="form-control select2" id="quar_mat_3_status" name="quar_mat_3_status">
                                                
                                                                        <option value="">Select Status</option>

                                                                        <option value="Withdraw" @if($quarter_final_status) @if(array_key_exists('match_3', $quarter_final_status)) {{ $quarter_final_status['match_3'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                        <option value="Retired" @if($quarter_final_status) @if(array_key_exists('match_3', $quarter_final_status)) {{ $quarter_final_status['match_3'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                        <option value="Decided by Organisers" @if($quarter_final_status) @if(array_key_exists('match_3', $quarter_final_status)) {{ $quarter_final_status['match_3'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8 mb-4">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                    @if($quarter_final_results) 
                                                                        @if(array_key_exists('match_3', $quarter_final_results)) 
                                                                            onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                        @else
                                                                            onclick="return confirm('Are you sure to submit the match result?');"
                                                                        @endif 
                                                ...
                                                <div class="col-xl-6 mt-4">
                                                    ...
                                                    <form class="needs-validation" action="{{ route('submit.quarter.final.result.four', $tournament->id) }}" method="post" novalidate="">
                                                    @csrf
                                                            ...
                                                            if($tournament->quarter_final_results) {
                                                                ...
                                                                if(array_key_exists('match_4', $find_results)) {
                                                                    ...
                                                                    foreach($results as $result_array) {
                                                                        if(array_key_exists('set_1', $result_array)) {
                                                                            $rs = $result_array['set_1'];
                                                                            array_push($quar_m4_s1, $rs);
                                                                        }

                                                                        if(array_key_exists('set_2', $result_array)) {
                                                                            $rs2 = $result_array['set_2'];
                                                                            array_push($quar_m4_s2, $rs2);
                                                                        }

                                                                        if(array_key_exists('set_3', $result_array)) {
                                                                            $rs3 = $result_array['set_3'];
                                                                            array_push($quar_m4_s3, $rs3);
                                                                        }
                                                                    }
                                                                }
                                                        ...
                                                        <input type="hidden" name="p1_m4" value="@if(array_key_exists('match_4', $quarter_final_matches)) {{ $p1_m4->id }} @endif">
                                                        <input type="hidden" name="p2_m4" value="@if(array_key_exists('match_4', $quarter_final_matches)) {{ $p2_m4->id }} @endif">

                                                        <div class="row mb-2">
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_4', $quarter_final_matches)) {{ $p1_m4->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8" style="margin-bottom: 0.7rem!important;">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m4_s1 ? $quar_m4_s1[0] : '' }}" @endif name="p1_m4_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m4_s2 ? $quar_m4_s2[0] : '' }}" @endif name="p1_m4_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m4_s3 ? $quar_m4_s3[0] : '' }}" @endif name="p1_m4_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2">
                                                            <label for="validationTooltip100" class="col-xl-4 col-form-label">@if(array_key_exists('match_4', $quarter_final_matches)) {{ $p2_m4->name }} @else N/A @endif</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="1st Set" @if($tournament->quarter_final_results) value="{{ $quar_m4_s1 ? $quar_m4_s1[1] : '' }}" @endif name="p2_m4_s1" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="2nd Set" @if($tournament->quarter_final_results) value="{{ $quar_m4_s2 ? $quar_m4_s2[1] : '' }}" @endif name="p2_m4_s2" required="">
                                                                    </div>

                                                                    <div class="col-4">
                                                                        <input type="number" min="0" max="7" class="form-control" id="validationTooltip01" placeholder="3rd Set" @if($tournament->quarter_final_results) value="{{ $quar_m4_s3 ? $quar_m4_s3[1] : '' }}" @endif name="p2_m4_s3">
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row mb-2" style="margin-top: 20px;">
                                                            <label for="quar_mat_4_status" class="col-xl-4 col-form-label text-info">Status</label>
                                                            
                                                            <div class="col-xl-8">
                                                                <div class="mb-1 position-relative">
                                                                    <select class="form-control select2" id="quar_mat_4_status" name="quar_mat_4_status">
                                                
                                                                        <option value="">Select Status</option>

                                                                        <option value="Withdraw" @if($quarter_final_status) @if(array_key_exists('match_4', $quarter_final_status)) {{ $quarter_final_status['match_4'] == 'Withdraw' ? "selected" : "" }} @endif @endif>Withdraw</option>

                                                                        <option value="Retired" @if($quarter_final_status) @if(array_key_exists('match_4', $quarter_final_status)) {{ $quarter_final_status['match_4'] == 'Retired' ? "selected" : "" }} @endif @endif>Retired</option>

                                                                        <option value="Decided by Organisers" @if($quarter_final_status) @if(array_key_exists('match_4', $quarter_final_status)) {{ $quarter_final_status['match_4'] == 'Decided by Organisers' ? "selected" : "" }} @endif @endif>Decided by Organisers</option>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8 mb-4">
                                                                <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 100%; margin: 0 auto;" 
                                                                    @if($quarter_final_results) 
                                                                        @if(array_key_exists('match_4', $quarter_final_results)) 
                                                                            onclick="return confirm('Match result have been added already. Are you sure to change the match result? It will affect the winners list.');" 
                                                                        @else
                                                                            onclick="return confirm('Are you sure to submit the match result?');"
                                                                        @endif 
                                    ...
                                    @if($tournament->quarter_final_results) 
                                        <form class="needs-validation" action="{{ route('submit.quarter.final.winners', $tournament->id) }}" method="post" novalidate="">
                                        @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <span style="margin-top:20px;"></span>
                                                        ...
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label text-dark"> Match - 1 (Left)</label>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <select class="form-control select2" id="quar_mat_1_winner" name="quar_mat_1_winner" required>
                                                                            ...
                                                                            <option value="">Select Player</option>
                                                                                ...
                                                                                @foreach($match as $value)
                                                                                    <?php 
                                                                                        $user = \App\Models\User::findOrFail($value);
                                                                                    ?>
                                                                                    <option value="{{ $user->id }}" @if($tournament->quarter_final_winners) @if(array_key_exists('match_1', $quarter_final_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('quar_mat_1_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_1_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                                @endforeach
                                                        ...
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label text-dark"> Match - 2 (Left)</label>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <select class="form-control select2" id="quar_mat_2_winner" name="quar_mat_2_winner" required>
                                                                            ...
                                                                            <option value="">Select Player</option>
                                                                                ...
                                                                                @foreach($match as $value)
                                                                                    <?php 
                                                                                        $user = \App\Models\User::findOrFail($value);
                                                                                    ?>
                                                                                    <option value="{{ $user->id }}" @if($tournament->quarter_final_winners) @if(array_key_exists('match_2', $quarter_final_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('quar_mat_2_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_2_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                                @endforeach
                                                        ...
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label text-dark"> Match - 3 (Right)</label>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <select class="form-control select2" id="quar_mat_3_winner" name="quar_mat_3_winner" required>
                                                                            ...
                                                                            <option value="">Select Player</option>
                                                                                ...
                                                                                @foreach($match as $value)
                                                                                    <?php 
                                                                                        $user = \App\Models\User::findOrFail($value);
                                                                                    ?>
                                                                                    <option value="{{ $user->id }}" @if($tournament->quarter_final_winners) @if(array_key_exists('match_3', $quarter_final_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('quar_mat_3_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_3_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                                @endforeach
                                                        ...
                                                        <div class="mb-3 position-relative">
                                                            <label class="form-label text-dark"> Match - 4 (Right)</label>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <select class="form-control select2" id="quar_mat_4_winner" name="quar_mat_4_winner" required>
                                                                            ...
                                                                            <option value="">Select Player</option>
                                                                                ...
                                                                                @foreach($match as $value)
                                                                                    <?php 
                                                                                        $user = \App\Models\User::findOrFail($value);
                                                                                    ?>
                                                                                    <option value="{{ $user->id }}" @if($tournament->quarter_final_winners) @if(array_key_exists('match_4', $quarter_final_winners)) {{ $winner == $user->id ? "selected" : "" }} @else {{ old('quar_mat_4_winner') == $user->id ? "selected" : "" }} @endif @else {{ old('quar_mat_4_winner') == $user->id ? "selected" : "" }} @endif>{{ $user->name }}</option>
                                                                                @endforeach
                                                    ...
                                                    @if(count($quarter_final_results) == 4) 
                                                        <button type="submit" class="btn btn-success btn-label waves-effect waves-light mt-3" style="width: 60%; margin: 0 auto;" @if($tournament->quarter_final_winners) onclick="return confirm('Winners have been selected already. Are you sure to change?');" @else onclick="return confirm('Are you sure to select these playes as Winners?');" @endif><i class="bx bx-add-to-queue label-icon"></i> @if($tournament->quarter_final_matches) Change @else Submit @endif Winners <i class="bx bx-right-arrow-circle bx-fade-right font-size-20 align-middle me-1"></i></button>
                                                    @endif    
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <span style="margin-top:20px;"></span>
                                            ...
                                            <?php 
                                                $w_arr_quar = json_decode($tournament->quarter_final_winners, true);
                                                $winners = [];

                                                if(array_key_exists('match_1', $w_arr_quar)) {
                                                    $win = $w_arr_quar['match_1'];
                                                    array_push($winners, $win);
                                                }

                                                if(array_key_exists('match_2', $w_arr_quar)) {
                                                    $win = $w_arr_quar['match_2'];
                                                    array_push($winners, $win);
                                                }

                                                if(array_key_exists('match_3', $w_arr_quar)) {
                                                    $win = $w_arr_quar['match_3'];
                                                    array_push($winners, $win);
                                                }

                                                if(array_key_exists('match_4', $w_arr_quar)) {
                                                    $win = $w_arr_quar['match_4'];
                                                    array_push($winners, $win);
                                                }
                                            ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <span style="margin-top:20px;"></span>
                                                ...
                                                <div class="col-xl-4"></div>
                                                 ...
                                                 <?php 
                                                    $w_arr_sem = json_decode($tournament->semi_final_winners, true);
                                                    $winners = [];

                                                    if(array_key_exists('match_1', $w_arr_sem)) {
                                                        $win = $w_arr_sem['match_1'];
                                                        array_push($winners, $win);
                                                    }

                                                    if(array_key_exists('match_2', $w_arr_sem)) {
                                                        $win = $w_arr_sem['match_2'];
                                                        array_push($winners, $win);
                                                    }

                                                    if(array_key_exists('match_3', $w_arr_sem)) {
                                                        $win = $w_arr_sem['match_3'];
                                                        array_push($winners, $win);
                                                    }

                                                    if(array_key_exists('match_4', $w_arr_sem)) {
                                                        $win = $w_arr_sem['match_4'];
                                                        array_push($winners, $win);
                                                    }
                                                ?>
                    ...
                    <div class="container">
                        <div class="split split-one">
                                            ...
                                            <ul class="matchup">
                                                ...
                                                <span class="custooltip">
                                                    <li
                                                        ...
                                                        {{ \Illuminate\Support\Str::limit($rou_1_mat_auto[0], 13) }}

                                                        <span
                                                            class="score winnerclractive">N/A</span>

                                                    </li>
                                                    <span class="custooltiptext">{{ $rou_1_mat_auto[0] }}</span>
                                                </span>
                                                        ...
                                                        @if($round_one_status)
                                                            @if (array_key_exists('match_'.$i, $round_one_status))
                                                                @if($round_one_status['match_'.$i])
                                                                    <?php
                                                                        ${"rou1_m" . $i . "_p1_total"} = ${"rou1_m" . $i . "_s1"}[0] + ${"rou1_m" . $i . "_s2"}[0] + ${"rou1_m" . $i . "_s3"}[0];
                                                                        ${"rou1_m" . $i . "_p2_total"} = ${"rou1_m" . $i . "_s1"}[1] + ${"rou1_m" . $i . "_s2"}[1] + ${"rou1_m" . $i . "_s3"}[1];
                                                                    ?>
                                                                    ...
                                                                    <ul class="matchup">
                                                                        ...
                                                                        <span class="custooltip">
                                                                            <li
                                                                                ...
                                                                                {{ \Illuminate\Support\Str::limit(${"rou_1_mat_" . $i}[0], 13) }}
                                                                            ...
                                                                            <span class="custooltiptext">{{ ${"rou_1_mat_" . $i}[0] }} @if (${"rou1_m" . $i . "_p1_total"} < ${"rou1_m" . $i . "_p2_total"}) ({{ $round_one_status['match_'.$i] }}) @endif</span>
                                                                        ...
                                                                        <span class="custooltip">
                                                                            <li
                                                                                ...
                                                                                {{ \Illuminate\Support\Str::limit(${"rou_1_mat_" . $i}[1], 13) }}
                                                                            ...
                                                                            <span class="custooltiptext">{{ ${"rou_1_mat_" . $i}[1] }} @if (${"rou1_m" . $i . "_p1_total"} > ${"rou1_m" . $i . "_p2_total"}) ({{ $round_one_status['match_'.$i] }}) @endif</span>
                                                                    ...
                                                                    @if (array_key_exists('match_'.$i, $round_one_results))
                                                                        ...
                                                                        <ul class="matchup">
                                                                            ...
                                                                            <span class="custooltip">
                                                                                ...
                                                                                <span class="custooltiptext">{{ ${"rou_1_mat_" . $i}[0] }}</span>
                                                                            </span>
                                                                            ...
                                                                            <span class="custooltip">
                                                                                ...
                                                                                <span class="custooltiptext">{{ ${"rou_1_mat_" . $i}[1] }}</span>
                                                                            </span>
                            ...
                            @if($quarter_final_auto_selection)
                                ...
                                <div class="round round-two @if($quarter_final_auto_selection) current @elseif($quarter_final_matches) current @endif">
                                        ...
                                        @if (array_key_exists('match_'.$i, $quarter_final_auto_selection))
                                            ...
                                            <ul class="matchup">
                                                ...
                                                <span class="custooltip">
                                                    <li
                                                        class="team team-top winnerclractive">
                                                        {{ \Illuminate\Support\Str::limit($quar_mat_auto[0], 13) }}
                                                        ...
                                                        @if($quarter_final_status)
                                                            @if (array_key_exists('match_'.$i, $quarter_final_status))
                                                                @if($quarter_final_status['match_'.$i])
                                                                    <?php
                                                                        ${"quar_m" . $i . "_p1_total"} = ${"quar_m" . $i . "_s1"}[0] + ${"quar_m" . $i . "_s2"}[0] + ${"quar_m" . $i . "_s3"}[0];
                                                                        ${"quar_m" . $i . "_p2_total"} = ${"quar_m" . $i . "_s1"}[1] + ${"quar_m" . $i . "_s2"}[1] + ${"quar_m" . $i . "_s3"}[1];
                                                                    ?>
                                                                    ...
                                                                    <ul class="matchup">
                                                                        ...
                                                                        <span class="custooltip">
                                                                            <li
                                                                                ...
                                                                                {{ \Illuminate\Support\Str::limit(${"quar_mat_" . $i}[0], 13) }}
                                                                            ...
                                                                            <span class="custooltiptext">{{ ${"quar_mat_" . $i}[0] }} @if (${"quar_m" . $i . "_p1_total"} < ${"quar_m" . $i . "_p2_total"}) ({{ $quarter_final_status['match_'.$i] }}) @endif</span>
                                                                        ...
                                                                        <span class="custooltip">
                                                                            <li
                                                                                ...
                                                                                {{ \Illuminate\Support\Str::limit(${"quar_mat_" . $i}[1], 13) }}
                                                                            ...
                                                                            <span class="custooltiptext">{{ ${"quar_mat_" . $i}[1] }} @if (${"quar_m" . $i . "_p1_total"} > ${"quar_m" . $i . "_p2_total"}) ({{ $quarter_final_status['match_'.$i] }}) @endif</span>
                            ...
                            @if($semi_final_auto_selection)
                                ...
                                <div class="round round-three @if($semi_final_auto_selection) current @elseif($semi_final_matches) current @endif">
                                        ...
                                        @if (array_key_exists('match_'.$i, $semi_final_auto_selection))
                                            ...
                                            <ul class="matchup">
                                                ...
                                                <span class="custooltip">
                                                    <li
                                                        class="team team-top winnerclractive">
                                                        {{ \Illuminate\Support\Str::limit($sem_mat_auto[0], 13) }}
                                                        ...
                                                        @if($semi_final_status)
                                                            @if (array_key_exists('match_'.$i, $semi_final_status))
                                                                @if($semi_final_status['match_'.$i])
                                                                    <?php
                                                                        ${"sem_m" . $i . "_p1_total"} = ${"sem_m" . $i . "_s1"}[0] + ${"sem_m" . $i . "_s2"}[0] + ${"sem_m" . $i . "_s3"}[0];
                                                                        ${"sem_m" . $i . "_p2_total"} = ${"sem_m" . $i . "_s1"}[1] + ${"sem_m" . $i . "_s2"}[1] + ${"sem_m" . $i . "_s3"}[1];
                                                                    ?>
                                                                    ...
                                                                    <ul class="matchup">
                                                                        ...
                                                                        <span class="custooltip">
                                                                            <li
                                                                                ...
                                                                                {{ \Illuminate\Support\Str::limit(${"sem_mat_" . $i}[0], 13) }}
                                                                            ...
                                                                            <span class="custooltiptext">{{ ${"sem_mat_" . $i}[0] }} @if (${"sem_m" . $i . "_p1_total"} < ${"sem_m" . $i . "_p2_total"}) ({{ $semi_final_status['match_'.$i] }}) @endif</span>
                                                                        ...
                                                                        <span class="custooltip">
                                                                            <li
                                                                                ...
                                                                                {{ \Illuminate\Support\Str::limit(${"sem_mat_" . $i}[1], 13) }}
                                                                            ...
                                                                            <span class="custooltiptext">{{ ${"sem_mat_" . $i}[1] }} @if (${"sem_m" . $i . "_p1_total"} > ${"sem_m" . $i . "_p2_total"}) ({{ $semi_final_status['match_'.$i] }}) @endif</span>
                                                ...
                                                @if($final_status)
                                                    @if (array_key_exists('match_'.$i, $final_status))
                                                        @if($final_status['match_'.$i])
                                                            <?php
                                                                ${"final_m" . $i . "_p1_total"} = ${"final_m" . $i . "_s1"}[0] + ${"final_m" . $i . "_s2"}[0] + ${"final_m" . $i . "_s3"}[0];
                                                                ${"final_m" . $i . "_p2_total"} = ${"final_m" . $i . "_s1"}[1] + ${"final_m" . $i . "_s2"}[1] + ${"final_m" . $i . "_s3"}[1];
                                                            ?>
                                                            ...
                                                            <ul class="matchup">
                                                                ...
                                                                <span class="custooltip">
                                                                    <li style="text-align: left;" 
                                                                        ...
                                                                        {{ \Illuminate\Support\Str::limit(${"final_mat_" . $i}[0], 13) }}
                                                                    ...
                                                                    <span class="custooltiptext">{{ ${"final_mat_" . $i}[0] }} @if (${"final_m" . $i . "_p1_total"} < ${"final_m" . $i . "_p2_total"}) ({{ $final_status['match_'.$i] }}) @endif</span>
                                                                ...
                                                                <span class="custooltip">
                                                                    <li style="text-align: left;" 
                                                                        ...
                                                                        {{ \Illuminate\Support\Str::limit(${"final_mat_" . $i}[1], 13) }}
                                                                    ...
                                                                    <span class="custooltiptext">{{ ${"final_mat_" . $i}[1] }} @if (${"final_m" . $i . "_p1_total"} > ${"final_m" . $i . "_p2_total"}) ({{ $final_status['match_'.$i] }}) @endif</span>
                                        ...
                                        @if (array_key_exists('match_'.$i, $semi_final_auto_selection))
                                            ...
                                            <ul class="matchup">
                                                ...
                                                <span class="custooltipleft">
                                                    ...
                                                    <span class="custooltiplefttext">{{ $sem_mat_auto[0] }}</span>
                                                </span>
                                                                ...
                                                                @if($semi_final_status['match_'.$i])
                                                                    ...
                                                                    <ul class="matchup">
                                                                        ...
                                                                        <span class="custooltipleft">
                                                                            ...
                                                                            <span class="custooltiplefttext">{{ ${"sem_mat_" . $i}[0] }} @if (${"sem_m" . $i . "_p1_total"} < ${"sem_m" . $i . "_p2_total"}) ({{ $semi_final_status['match_'.$i] }}) @endif</span>
                                                                        ...
                                                                        <span class="custooltipleft">
                                                                            ...
                                                                            <span class="custooltiplefttext">{{ ${"sem_mat_" . $i}[1] }} @if (${"sem_m" . $i . "_p1_total"} > ${"sem_m" . $i . "_p2_total"}) ({{ $semi_final_status['match_'.$i] }}) @endif</span>
                                                                    ...
                                                                    @if (array_key_exists('match_'.$i, $semi_final_results))
                                                                        ...
                                                                        <ul class="matchup">
                                                                            ...
                                                                            <span class="custooltipleft">
                                                                                ...
                                                                                <span class="custooltiplefttext">{{ ${"sem_mat_" . $i}[0] }}</span>
                                                                            </span>
                                                                            ...
                                                                            <span class="custooltipleft">
                                                                                ...
                                                                                <span class="custooltiplefttext">{{ ${"sem_mat_" . $i}[1] }}</span>
                                                                            </span>
                                        ...
                                        @if (array_key_exists('match_'.$i, $quarter_final_auto_selection))
                                            ...
                                            <ul class="matchup">
                                                ...
                                                <span class="custooltipleft">
                                                    ...
                                                    <span class="custooltiplefttext">{{ $quar_mat_auto[0] }}</span>
                                                </span>
                                                                ...
                                                                @if($quarter_final_status['match_'.$i])
                                                                    ...
                                                                    <ul class="matchup">
                                                                        ...
                                                                        <span class="custooltipleft">
                                                                            ...
                                                                            <span class="custooltiplefttext">{{ ${"quar_mat_" . $i}[0] }} @if (${"quar_m" . $i . "_p1_total"} < ${"quar_m" . $i . "_p2_total"}) ({{ $quarter_final_status['match_'.$i] }}) @endif</span>
                                                                        ...
                                                                        <span class="custooltipleft">
                                                                            ...
                                                                            <span class="custooltiplefttext">{{ ${"quar_mat_" . $i}[1] }} @if (${"quar_m" . $i . "_p1_total"} > ${"quar_m" . $i . "_p2_total"}) ({{ $quarter_final_status['match_'.$i] }}) @endif</span>
                                                                    ...
                                                                    @if (array_key_exists('match_'.$i, $quarter_final_results))
                                                                        ...
                                                                        <ul class="matchup">
                                                                            ...
                                                                            <span class="custooltipleft">
                                                                                ...
                                                                                <span class="custooltiplefttext">{{ ${"quar_mat_" . $i}[0] }}</span>
                                                                            </span>
                                                                            ...
                                                                            <span class="custooltipleft">
                                                                                ...
                                                                                <span class="custooltiplefttext">{{ ${"quar_mat_" . $i}[1] }}</span>
                                                                            </span>
                                        ...
                                        @if (array_key_exists('match_'.$i, $round_one_auto_selection))
                                            ...
                                            <ul class="matchup">
                                                ...
                                                <span class="custooltipleft">
                                                    ...
                                                    <span class="custooltiplefttext">{{ $rou_1_mat_auto[0] }}</span>
                                                </span>
                                                                ...
                                                                @if($round_one_status['match_'.$i])
                                                                    ...
                                                                    <ul class="matchup">
                                                                        ...
                                                                        <span class="custooltipleft">
                                                                            ...
                                                                            <span class="custooltiplefttext">{{ ${"rou_1_mat_" . $i}[0] }} @if (${"rou1_m" . $i . "_p1_total"} < ${"rou1_m" . $i . "_p2_total"}) ({{ $round_one_status['match_'.$i] }}) @endif</span>
                                                                        ...
                                                                        <span class="custooltipleft">
                                                                            ...
                                                                            <span class="custooltiplefttext">{{ ${"rou_1_mat_" . $i}[1] }} @if (${"rou1_m" . $i . "_p1_total"} > ${"rou1_m" . $i . "_p2_total"}) ({{ $round_one_status['match_'.$i] }}) @endif</span>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3 position-relative text-center">                                            
                                        <label for="" class="form-label text-success">The group stage is completed. Want to see the group stage?</label>
                                        
                                        <div><a class="btn btn-success" href="{{ route('group.league', $tournament->id) }}" style="margin-top: 6px !important; width: 50% !important">View Group Stage</a></div>
