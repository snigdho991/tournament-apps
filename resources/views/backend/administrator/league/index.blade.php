        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="staticBackdropLabel">Participating Players (League)</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">All Leagues</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">All Leagues</li>
                            </ol>
                        </div>
                            ...
                            <div class="card border border-{{ $statusclr }}">
                                ...
                                <div class="card-body" style="text-align: center;">
                                    ...
                                    <span style="display: inline-flex; flex-direction: row; gap: 10px;">
                                        ...
                                        <button class="btn btn-light btn-sm waves-effect waves-light" style="margin-top: 6px;" id="getLeagPlayers" data-bs-toggle="modal" data-bs-target="#staticBackdropD" data-url="{{ route('get.league.players', $league->id) }}"><i class="bx bxs-group" style="position: relative;top: 0.67px;"></i> {{ count($league_participants) }} Participants</button>
                                    ...
                                    <ul class="list-inline mb-0 font-size-16" style="margin-top: 25px;">
                                        <li class="list-inline-item">
                                            <a href="{{ route('edit.league', $league->id) }}" class="text-success p-1"><i class="bx bxs-edit-alt"></i></a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="{{ route('delete.league', $league->id) }}" onclick="return confirm('Are you sure to delete permanently?')" class="text-danger p-1"><i class="bx bxs-trash"></i></a>
                                        </li>
                                    </ul>
                                ...
                                <div class="card-footer" style="margin-top: -10px;">
                                    ...
                                    <a href="{{ route('group.league', $league->id) }}" style="width: 100%;" class="btn btn-{{ $statusclr }} waves-effect waves-light">@if($league->group_size && $league->player_per_group) View Draw @else Draw League @endif <i class="bx bx-right-arrow-circle bx-tada font-size-20 align-middle ms-1"></i></a>
