            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">League Group ({{ count($players) }} Players)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard </a></li>
                                <li class="breadcrumb-item active" style="color: #74788d;">League Group </li>
                            </ol>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="mb-3 position-relative">                                            
                                            ...
                                            <button class="btn btn-primary" onclick="return confirm('Are you sure?');" style="margin-top: 6px !important; width: 100% !important" type="submit">Generate League Groups</button>
                                ...
                                <div class="card-body">
                                    @for($i = 1; $i < $league->group_size + 1; $i++)
                                        ...
                                        @if($league->{"group_" . $grp_word . "_status"})
                                            ...
                                            @else
                                                <div class="text-center text-danger font-size-15">No retires found !</div>
                                            @endif
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12">
                                            ...
                                            <div class="mb-3 position-relative text-center">                                            
                                                ...
                                                <div><a class="btn btn-success" @if($league->tree_size == 8) href="{{ route('draw.league.eight.players', $league->id) }}" @elseif($league->tree_size == 16) href="{{ route('draw.league.sixteen.players', $league->id) }}" @else href="{{ route('draw.league.thirtytwo.players', $league->id) }}" @endif style="margin-top: 6px !important; width: 50% !important">Manage Generated Tree</a></div>
                                ...
                                @else
                                    <form class="needs-validation" action="{{ route('tree.league', $league->id) }}" method="post" novalidate="">
                                    @csrf
                                    <input type="hidden" name="chk_type" value="League">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="mb-3 position-relative">
                                                    ...
                                                    <select class="form-control select2" id="validationTooltip01" name="tree_size" required="">
                                                        ...
                                                        <option @if($league->tree_size == '32') selected @endif value="32">32 Players</option>
                                            ...
                                            <div class="col-xl-12">
                                                ...
                                                <div class="mb-3 position-relative text-center">                                            
                                                    <label for="" class="form-label text-danger">Is the group stage completed? Generate a 8, 16 or 32 players tree with the winners of the groups.</label>
