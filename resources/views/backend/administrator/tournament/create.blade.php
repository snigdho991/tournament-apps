...
@section('title', 'Add New Tournament')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add New Tournament</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard </a></li>
                                <li class="breadcrumb-item active" style="color: #74788d;">Add New Tournament</li>
                            </ol>
                        </div>
                            ...
                            @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="input-group" id="datepicker4">
                                                <input type="text" name="start" value="{{ old('start') }}" placeholder="Select tournament start month" class="form-control" data-date-container='#datepicker4' data-provide="datepicker" data-date-format="MM yyyy" data-date-min-view-mode="1" required>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="mb-3 position-relative">                                            
                                            ...
                                            <div class="input-group" id="datepicker4">
                                                <input type="text" name="end" value="{{ old('end') }}" placeholder="Select tournament end month" class="form-control" data-date-container='#datepicker4' data-provide="datepicker" data-date-format="MM yyyy" data-date-min-view-mode="1" required>
                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" id="name" placeholder="Enter tournament name" required="">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <input type="number" name="fees" value="{{ old('fees') }}" step="0.01" class="form-control" id="fees" placeholder="Enter tournament fees" required="">
                                ...
                                {{-- <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3 position-relative">
                                            ...
                                            <select class="form-control select2" id="tournament_type" name="tournament_type" required="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <button class="btn btn-primary" style="margin-top: 6px !important; width: 100% !important" type="submit">Save New Tournament</button>
