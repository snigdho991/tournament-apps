...
@section('title', 'Administrator - Pending Tournament Participations')
...
@section('content')
    ...
    <div class="modal fade approveModal" tabindex="-1" role="dialog" aria-labelledby="transaction-detailModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title">Approve Participation</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="" method="post" id="approve" novalidate="">
                        ...
                        <div class="mb-3">
                            ...
                            <label for="paymentInfoModal" class="form-label">Payment Info</label>
                            <textarea class="form-control" id="paymentInfoModal" placeholder="Enter Payment Information" name="payment_info" rows="2" required="">{{ old('payment_info') }}</textarea>
                    
                        </div>

                        <button class="btn btn-success waves-effect btn-label waves-light" onclick="return confirm('Are you sure to approve the tournament participation ?');" style="margin-top: 6px !important; width: 100% !important" type="submit"> Approve Participation</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="" method="post" id="decline" novalidate="">
                        ...
                        <button class="btn btn-danger waves-effect btn-label waves-light" onclick="return confirm('Are you sure to  decline the tournament participation ?');" style="margin-top: 6px !important; width: 100% !important" type="submit"> Decline Participation</button>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Pending Tournament Participations (<?php echo $pending->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Pending Tournament Participations(Administrator)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administrator - Pending Tournament Participations (<?php echo $pending->count(); ?>)</b></span>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <span style="display: inline-flex; flex-direction: row; gap: 15px;">
                                                    ...
                                                    <button type="button" class="btn btn-success btn-sm waves-effect btn-label waves-light" data-bs-toggle="modal" data-partid="{{ $data->id }}" data-bs-target=".approveModal">
    ...
    <script type="text/javascript">
        ...
        $('.approveModal').on('show.bs.modal', function(e) {
            var link           = $(e.relatedTarget),
                ...
                document.getElementById("approve").action = "/administrator/approve/tournament/participation/" + partid;
