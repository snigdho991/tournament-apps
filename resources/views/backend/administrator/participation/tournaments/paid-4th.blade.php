...
@section('title', 'Administrator - Paid Tournament 4th Draw Participations')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Paid Tournament 4th Draw Participations (<?php echo $paid->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Paid Tournament 4th Draw Participations(Administrator)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administrator - Paid Tournament 4th Draw Participations (<?php echo $paid->count(); ?>)</b><br><p style="margin-top: 7px; font-size: 80%; margin-bottom: 0px;">Total Paid: {{ $amount }} €</p></span>    
