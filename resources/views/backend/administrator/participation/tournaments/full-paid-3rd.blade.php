...
@section('title', 'Administrator - Full Members Tournament 3rd Draw Preferences')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Full Members Tournament 3rd Draw Preferences (<?php echo $paid->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Full Members Tournament 3rd Draw Preferences(Administrator)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administrator - Full Members Tournament Preferences - 3rd Draw (<?php echo $paid->count(); ?>)</b></span>
