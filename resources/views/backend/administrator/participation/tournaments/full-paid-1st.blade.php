...
@section('title', 'Administrator - Full Members Tournament 1st Draw Preferences')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Full Members Tournament 1st Draw Preferences (<?php echo $paid->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Full Members Tournament 1st Draw Preferences(Administrator)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administrator - Full Members Tournament Preferences - 1st Draw (<?php echo $paid->count(); ?>)</b></span>
                                <h6 class="mb-0"> <a href="{{ route('admin.full.tournaments.participations') }}">All Draws</a> || <a href="{{ route('admin.full.tournaments.participations.first') }}">1st Draw</a> || <a href="{{ route('admin.full.tournaments.participations.second') }}">2nd Draw</a> || <a href="{{ route('admin.full.tournaments.participations.third') }}">3rd Draw</a> || <a href="{{ route('admin.full.tournaments.participations.fourth') }}">4th Draw</a> </h6>
                            </h5> 
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="CellWithComment">
                                                    ...
                                                    <span class="CellComment" style="background-color:#34c38f !important;">Full Member</span>
                                                </span>
                                            </td>
