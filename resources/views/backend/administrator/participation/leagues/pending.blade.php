...
@section('title', 'Administrator - Pending League Participations')
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="" method="post" id="approve" novalidate="">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="paymentInfoModal" placeholder="Enter Payment Information" name="payment_info_league" rows="2" required="">{{ old('payment_info_league') }}</textarea>
                    
                        </div>

                        <button class="btn btn-success waves-effect btn-label waves-light" onclick="return confirm('Are you sure to  approve the league participation ?');" style="margin-top: 6px !important; width: 100% !important" type="submit"> Approve Participation</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="" method="post" id="decline" novalidate="">
                        ...
                        <button class="btn btn-danger waves-effect btn-label waves-light" onclick="return confirm('Are you sure to decline the league participation ?');" style="margin-top: 6px !important; width: 100% !important" type="submit"> Decline Participation</button>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Pending League Participations (<?php echo $pending->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Pending League Participations(Administrator)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administrator - Pending League Participations (<?php echo $pending->count(); ?>)</b></span>
    ...
    <script type="text/javascript">
        ...
        $('.approveModal').on('show.bs.modal', function(e) {
            var link           = $(e.relatedTarget),
                ...
                document.getElementById("approve").action = "/administrator/approve/league/participation/" + partid;
