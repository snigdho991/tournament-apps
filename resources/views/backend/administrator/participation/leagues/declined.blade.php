...
@section('title', 'Administrator - Declined League Participations')
                ...
                <div class="modal-body">
                    <form class="needs-validation" action="" method="post" id="approve" novalidate="">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="validationTooltip02" placeholder="Enter Payment Information" name="payment_info_league" rows="2" required="">{{ old('payment_info_league') }}</textarea>
                    
                        </div>

                        <button class="btn btn-success waves-effect btn-label waves-light" onclick="return confirm('Are you sure to approve this already declined league participation ?');" style="margin-top: 6px !important; width: 100% !important" type="submit"> Approve Participation</button>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Declined League Participations (<?php echo $declined->count(); ?>)</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Declined League Participations(Administrator)</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administrator - Declined League Participations (<?php echo $declined->count(); ?>)</b></span>
                                ...
                                <tbody>
                                    @foreach($declined as $key => $data)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $data->decline_reason_league }}</td>
