...
@section('title', 'Administrator - Approved Membership')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Approved Membership (<?php echo $approved->count(); ?>)</h4>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body" style="text-align: center;">
                            <h5>
                                <span class="text-success"><b> Administrator - Approved Membership (<?php echo $approved->count(); ?>)</b><br><p style="margin-top: 7px; font-size: 80%; margin-bottom: 0px;">Total Paid: {{ $money_count * 100 }} €</p></span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="CellWithComment">
                                                    ...
                                                    <span class="CellComment" style="background-color:#34c38f !important;">Approved</span>
                                                </span>
                                            </td>

                                            <td>{{ $user->name }}</td>
                                            <td>{{ $user->phone }}</td>
                                            <td><span style="font-weight: 500;">@if (ucfirst(strtolower(trim($data->payment_info))) === 'Free') 0 € @else 120 € @endif</span></td>
