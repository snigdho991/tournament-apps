...
@section('title', 'Previous Winners - Tournaments')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Previous Winners - Tournaments</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Previous Winners - Tournaments</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <form action="{{ route('previous.tournament.winners') }}" method="get">
                                <div class="row">
                                    <div class="col-sm-4">
            ...
            <div class="row">
                ...
                @if($tournaments->count() > 0)   
                    @foreach($tournaments as $tournament)
                        <?php 
                            $statusclr = 'success';
                            $winnerArray = (array) json_decode($tournament->final_winners);
                        ...
                        <div class="col-lg-3">
                            <div class="card border border-{{ $statusclr }}">
                                ...
                                <div class="card-body" style="text-align: center;">
                                    <h6 class="mt-0" style="color: #5e7079;">{{ date('F y', strtotime($tournament->start)) }} - {{ date('F y', strtotime($tournament->end)) }}</h6>
                                ...
                                <div class="card-footer" style="margin-top: -10px;">
                                    ...
                                    <a href="{{ route('view.tournament.tree', $tournament->id) }}" style="width: 100%;" class="btn btn-{{ $statusclr }} waves-effect waves-light">Tournament Tree<i class="bx bx-right-arrow-circle bx-tada font-size-20 align-middle ms-1"></i></a>
