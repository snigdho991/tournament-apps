...
@section('title', 'Complete Participation')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Complete Participation</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('player.dashboard') }}">Dashboard </a></li>
                                <li class="breadcrumb-item active" style="color: #74788d;">Complete Participation</li>
                            </ol>
                        </div>
                ...
                <div class="col-lg-7">
                            ...
                            @if($auth_part->tournaments)
                                ...
                                <div class="alert alert-success" style="text-align: center; margin-bottom: 40px;padding: 4px;" role="alert">
                                    ...
                                    <marquee direction="left" style="font-weight: 410;margin-top: 5px;font-size: 14.5px;">
                                        <span style="color: #343a40!important"><i class="bx bx-bell bx-tada" style="position: relative; top: 1.5px;"></i> Notification:</span> <span class="badge bg-success rounded-pill" style="position: relative; top: -1.5px;">1</span> You have already participated in the <strong>{{ $settings->tournaments_open_for }}</strong> of the tournaments! Please <a href="@if($auth_part->status == 'Pending') {{ route('player.pending.tournaments.participations') }} @elseif($auth_part->status == 'Paid') {{ route('player.paid.tournaments.participations') }} @elseif($auth_part->status == 'Declined') {{ route('player.declined.tournaments.participations') }} @endif" style="color: #222;">click here</a> to check the participation.
                                    </marquee>
                                   
                                </div>
                            @else
                                <form class="needs-validation" action="{{ route('store.tournaments.participation') }}" method="post" novalidate="">
                                @csrf
                                    <div class="card border border-success">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <input type="hidden" name="league_fees" value="{{ $auth_part->league_fees }}">
                                        ...
                                        <div class="card-footer">
                                            <div class="row">
                                                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-6">
                                                    <button type="submit" name="online_payment" style="width: 100%;" class="btn btn-success btn-label waves-effect waves-light">
                                                ...
                                                <div class="col-12 col-md-6 col-sm-6 col-lg-6 col-xl-6 cusGap">
                                                    <button type="submit" name="offline_payment" onclick="return confirm('Are you sure to participate?')" style="width: 100%;border: 1px solid #efe9e9 !important;color: #555 !important;" class="btn btn-light btn-label waves-effect waves-light">
                    ...
                    @else
                        <div class="alert alert-dismissible alert-warning" style="text-align: center; margin-bottom: 40px;padding: 4px;" role="alert">
                            ...
                            <marquee direction="left" style="font-weight: 410;margin-top: 5px;font-size: 14.5px;">
                                <span style="color: #343a40!important"><i class="bx bx-bell bx-tada" style="position: relative; top: 1.5px;"></i> Notification:</span> <span class="badge bg-danger rounded-pill" style="position: relative; top: -1.5px;">1</span> No open tournament found for the {{ $settings->tournaments_open_for }} ! Please <span style="color: #222;">try again </span> later.
                            </marquee>
                        ...
                        @if($league_auth_part)
                            ...
                            @if($league_auth_part->leagues)
                                ...
                                <div class="alert alert-info" style="text-align: center; margin-bottom: 40px;padding: 4px;" role="alert">
                                    ...
                                    <marquee direction="left" style="font-weight: 410;margin-top: 5px;font-size: 14.5px;">
                                        <span style="color: #343a40!important"><i class="bx bx-bell bx-tada" style="position: relative; top: 1.5px;"></i> Notification:</span> <span class="badge bg-info rounded-pill" style="position: relative; top: -1.5px;">1</span> You have already participated in the <strong>{{ $settings->leagues_open_for }}</strong> of the leagues! Please <a href="@if($league_auth_part->league_status == 'Pending') {{ route('player.pending.leagues.participations') }} @elseif($league_auth_part->league_status == 'Paid') {{ route('player.paid.leagues.participations') }} @elseif($league_auth_part->league_status == 'Declined') {{ route('player.declined.leagues.participations') }} @endif" style="color: #222;">click here</a> to check the participation.
                                    </marquee>
                                    
                                </div>
                            @else
                                <form class="needs-validation" action="{{ route('store.leagues.participation') }}" method="post" novalidate="">
                                @csrf
                                    <div class="card border border-success">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3"></div>
                                                <div class="col-md-4 text-center">
                                                    <h5 class="text-primary">For {{ $settings->leagues_open_for }}</h5>
                                                </div>
                                                <div class="col-md-5"></div>
                                            </div>
                                            <br>
                                            <div class="row">
                                                ...
                                                <div class="col-md-5 mt-3">
                                                    <div class="mb-3 position-relative">
                                                        <label for="validationTooltip01" class="form-label" style="font-size: 16px;">
                                                            Choose Leagues
                                                            <span class="text-primary">For {{ $settings->leagues_open_for }}</span>
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <input type="hidden" name="tournament_fees" value="{{ $league_auth_part->tournament_fees }}">
                    ...
                    @else
                        <div class="alert alert-dismissible alert-warning" style="text-align: center; margin-bottom: 40px;padding: 4px;" role="alert">
                            ...
                            <marquee direction="left" style="font-weight: 410;margin-top: 5px;font-size: 14.5px;">
                                <span style="color: #343a40!important"><i class="bx bx-bell bx-tada" style="position: relative; top: 1.5px;"></i> Notification:</span> <span class="badge bg-danger rounded-pill" style="position: relative; top: -1.5px;">1</span> No open league found for the {{ $settings->leagues_open_for }} ! Please <span style="color: #222;">try again </span> later.
                            </marquee>
                            <button type="button" class="btn-close text-white" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="card border border-success">
                        <div class="card-body">
                            ...
                            <p class="font-size-12 mt-1" style="color: #777 !important; text-align: center;">To make it easier for you we offer a variety of ways to pay your fees.</p>
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-nowrap" style="margin-bottom: -5px; margin-top: -10px;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td >
                                                <p class="mb-0"><i class="mdi mdi-chevron-right text-primary me-1"></i> Revolut, QuickPay </p>
                                            </td>
                                            
                                        </tr>
                                        <tr>
                                            <td >
                                                <p class="mb-0"><i class="mdi mdi-chevron-right text-primary me-1"></i> Stripe (Online Card Payment) </p>
                                            </td>
