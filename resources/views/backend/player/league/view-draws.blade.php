...
@section('title', 'View Draw & Tree - Leagues')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">View Draw & Tree - Leagues</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">View Draw & Tree - Leagues</li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <form action="{{ route('view.league.draws') }}" method="get">
                                <div class="row">
                                    <div class="col-sm-4">
                            ...
                            <div class="card border border-{{ $statusclr }}">
                                ...
                                <div class="card-body" style="text-align: center;">
                                    ...
                                    <span style="display: inline-flex; flex-direction: row; gap: 10px;">
                                        ...
                                        <button class="btn btn-light btn-sm waves-effect waves-light" style="margin-top: 6px;" id="getTourPlayers" data-bs-toggle="modal" data-bs-target="#staticBackdropD" data-url="{{ route('get.league.players', $league->id) }}"><i class="bx bxs-group" style="position: relative;top: 0.67px;"></i> {{ count($participants) }} Participants</button>
                        ...
                        <div class="mt-auto">
                            <div class="alert alert-danger fade show px-3 mb-0" role="alert">
                                ...
                                <div>
                                    ...
                                    <p><span style="font-weight: 500;">{{ request('draw') ? request('draw') : 'All Draws' }}</span> of league is not found for the year <span style="font-weight: 500;">{{ request('year') ? request('year') : date('Y') }}</span> till now !</p>                                        
                                </div>
                            </div>                                
                        </div>
                    </div>
