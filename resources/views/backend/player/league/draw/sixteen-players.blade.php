        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">League Draw & Tree</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard </a></li>
                                <li class="breadcrumb-item active" style="color: #74788d;">View League Tree</li>
                            </ol>
                        </div>
            ...
            <div class="row mb-1 mt-1">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="mb-sm-0 font-size-14 text-center text-success">League : <span style="font-weight: 510;">{{ $tournament->name }}</span> ({{ count($players) }} Participations)</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                @if($tournament->tree_size == 16)
                    <header class="hero">
                        <div class="hero-wrap">
                         ...
                         <p>Knockout Fixtures ({{ $tournament->tree_size }} Players)</p>
                       </div>
                    </header>
