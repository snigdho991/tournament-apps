...
@section('title', 'My Declined Participations - Tournaments')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">My Declined Participations - Tournaments ({{ date('Y') }})</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">My Declined Participations - Tournaments</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
                ...
                @foreach($declineds as $declined)
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body" style="text-align: center;">
                                    <h5>
                                        <span class="text-danger"><b>{{ $declined->draw_status }} of Tournaments</b><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6"><p style="margin-top: 15px; font-size: 80%; margin-bottom: 0px;">Declined Tournament Fees: <span style="font-weight:510;">{{ $declined->tournament_fees }} €</span></p></div>
                    ...
                    <div class="row">
                        ...
                        @foreach(json_decode($declined->tournaments) as $single_tournament)
                            <?php $participants = []; ?>
                            <?php 
