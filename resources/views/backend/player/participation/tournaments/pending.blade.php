...
@section('title', 'My Pending Participations - Tournaments')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">My Pending Participations - Tournaments ({{ date('Y') }})</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">My Pending Participations - Tournaments</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
                ...
                @foreach($pendings as $pending)
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body" style="text-align: center;">
                                    <h5>
                                        <span class="text-info"><b>{{ $pending->draw_status }} of Tournaments</b><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6"><p style="margin-top: 15px; font-size: 80%; margin-bottom: 0px;">Participation Code: <span style="font-weight:510;">{{ $pending->participation_code }}</span></p></div>
                                                        <div class="col-lg-6"><p style="margin-top: 15px; font-size: 80%; margin-bottom: 0px;">Pending Tournament Fees: <span style="font-weight:510;">{{ $pending->tournament_fees }} €</span></p></div>
                    ...
                    <div class="row">
                        ...
                        @foreach(json_decode($pending->tournaments) as $single_tournament)
                            <?php $participants = []; ?>
                            <?php 
                            ...
                            <div class="col-lg-3">
                                <div class="card border border-{{ $statusclr }}">
                                    ...
                                    <div class="card-footer" style="margin-top: -10px;">
                                        ...
                                        <a href="#" onclick='return confirm("Your payment is pending yet. The payment should be verified to access the draw." )' style="width: 100%;" class="swalalertpending btn btn-info waves-effect waves-light">View Draw <i class="bx bx-right-arrow-circle bx-tada font-size-20 align-middle ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
