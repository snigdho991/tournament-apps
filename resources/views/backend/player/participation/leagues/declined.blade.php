...
@section('title', 'My Declined Participations - Leagues')

@section('content')

    
    <div class="modal fade" id="staticBackdropLeague" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabelTour" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title text-center" id="staticBackdropLabelTour">Participating Players (League)</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">My Declined Participations - Leagues ({{ date('Y') }})</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">My Declined Participations - Leagues</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
                ...
                @foreach($declineds as $declined)
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body" style="text-align: center;">
                                    <h5>
                                        <span class="text-danger"><b>{{ $declined->league_draw_status }} of Leagues</b><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6"><p style="margin-top: 15px; font-size: 80%; margin-bottom: 0px;">Participation Code: <span style="font-weight:510;">{{ $declined->participation_code }}</span></p></div>
                                                        <div class="col-lg-6"><p style="margin-top: 15px; font-size: 80%; margin-bottom: 0px;">Declined League Fees: <span style="font-weight:510;">{{ $declined->league_fees }} €</span></p></div>
                    ...
                    <div class="row">
                        ...
                        @foreach(json_decode($declined->leagues) as $single_league)
                            <?php $participants = []; ?>
                            <?php 
                                ...
                                <div class="card border border-{{ $statusclr }}">
                                    ...
                                    <div class="card-body" style="text-align: center;">
                                        ...
                                        <span style="display: inline-flex; flex-direction: row; gap: 10px;">
                                            ...
                                            <button class="btn btn-light btn-sm waves-effect waves-light" style="margin-top: 6px;" id="getTourPlayers" data-bs-toggle="modal" data-bs-target="#staticBackdropLeague" data-url="{{ route('get.league.players', $league->id) }}"><i class="bx bxs-group" style="position: relative;top: 0.67px;"></i> {{ count($participants) }} Participants</button>
                                    ...
                                    <div class="card-footer" style="margin-top: -10px;">
                                        ...
                                        <a href="#" onclick='return confirm("Your payment is declined. You can not view or access the draw result of a declined payment." )' style="width: 100%;" class="swalalertdeclined btn btn-danger waves-effect waves-light">View Draw <i class="bx bx-right-arrow-circle bx-tada font-size-20 align-middle ms-1"></i></a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
