...
@section('title', 'My Pending Participations - Leagues')
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">My Pending Participations - Leagues ({{ date('Y') }})</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">My Pending Participations - Leagues</li>
                            </ol>
                        </div>
            ...
            <!-- end page title -->
                ...
                @foreach($pendings as $pending)
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body" style="text-align: center;">
                                    <h5>
                                        <span class="text-info"><b>{{ $pending->league_draw_status }} of Leagues</b><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6"><p style="margin-top: 15px; font-size: 80%; margin-bottom: 0px;">Pending League Fees: <span style="font-weight:510;">{{ $pending->league_fees }} €</span></p></div>
                    ...
                    <div class="row">
                        ...
                        @foreach(json_decode($pending->leagues) as $single_league)
                            <?php $participants = []; ?>
                            <?php 
